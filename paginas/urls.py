...
from relatorios.views import relatorio_maquinas_manutencoes
from gerirUsuarios.views import (
    UsuarioListView,
    UsuarioCreateView,
    UsuarioUpdateView,
    UsuarioDeleteView,
...
urlpatterns = [
    ...
    path(
        "editar-usuario/<int:pk>/", UsuarioUpdateView.as_view(), name="editar_usuario"
    ),
    path(
        "excluir-usuario/<int:pk>/", UsuarioDeleteView.as_view(), name="excluir_usuario"
    ),
    # Maquinas
    ...
    path(
        "editar-maquina/<int:pk>/", MaquinaUpdateView.as_view(), name="editar_maquinas"
    ),
    path(
        "excluir-maquina/<int:pk>/",
        MaquinaDeleteView.as_view(),
        name="excluir_maquinas",
    ),
    # Manutencoes
    ...
    path(
        "editar-manutencao/<int:pk>/",
        ManutencaoUpdateView.as_view(),
        name="editar_manutencao",
    ),
    path(
        "deletar-manutencao/<int:pk>/",
        ManutencaoDeleteView.as_view(),
        name="deletar_manutencao",
    ),
    ...
    #Relatorios
    path("relatorios/", relatorio_maquinas_manutencoes, name="relatorios_manutencoes"),
